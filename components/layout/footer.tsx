...
export function Footer() {
  return (
    <footer className="flex flex-col gap-2 border-t border-hairline px-10 py-3.5 font-mono text-[11px] text-faint md:flex-row md:items-center md:justify-between">
