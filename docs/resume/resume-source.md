...
**Publication rule (pinned, pending sign-off):** the phone number in the docx
is EXCLUDED from every web-published version (page, /resume.md, knowledge
base) — email, LinkedIn, GitHub, and site URL are fine to publish.
...
- **Engineering:** TypeScript, React, Next.js, Node.js, Python, SQL,
  PostgreSQL, Supabase, Prisma, Stripe, REST APIs, ETL & data workflows
- **GTM systems & analytics:** Salesforce, Power BI, DAX, Power Apps / Power
  Automate, SharePoint, Excel/VBA
- **Domain:** GTM / revenue systems, sales ops & RevOps, solutions
  engineering / pre-sales, forecasting, stakeholder management
